...
| [usage.md](usage.md) | Guide d'utilisation des cinq commandes de l'outil en ligne de commande. |
...
| Fichier | Rôle |
| --- | --- |
| `rag_posts.py` | Script principal, contient tout le code (846 lignes). |
